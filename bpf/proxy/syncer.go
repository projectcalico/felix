...
// ConntrackFrontnedHasBackend returns true if the given front-backend pair exists
func (s *Syncer) ConntrackFrontnedHasBackend(ip net.IP, port uint16,
...
// ConntrackScanStart excludes Apply from running and builds the acite maps from
// ConntrackFrontnedHasBackend
