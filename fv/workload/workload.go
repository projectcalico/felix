...
func (w *Workload) StartPermanentConnection(ip string, port int,
	opts PermanentConnectionOpts) *connectivity.PermanentConnection {

	pc := &connectivity.PermanentConnection{
