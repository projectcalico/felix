...
// already updated the Policy or Profile itself, but the endpointManager is responsible for requesting all impacted
// policy sets to be updated and for marking all impacted endpoints as pending so that updated policies can be
// pushed to them.
