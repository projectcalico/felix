...
from calico.felix.ipsets import HOSTS_IPSET_V6
...
def install_global_rules(config, v4_filter_updater, v6_filter_updater,
    ...
    for iptables_updater, hosts_set in [(v4_filter_updater, HOSTS_IPSET_V4),
                                        (v6_filter_updater, HOSTS_IPSET_V6)]:
        ...
        if config.IP_IN_IP_ENABLED and hosts_set == HOSTS_IPSET_V4:
            # FIXME ip-in-ip for v6?
            input_chain[:0] = [
